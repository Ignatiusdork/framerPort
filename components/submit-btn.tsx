...
function SubmitBtn() {
  ...
  return (
    <button 
    type='submit'
    className='flex group items-center justify-center gap-2 h-[3rem] w-[8rem]
    bg-gray-900 text-white rounded-full outline-none transition-all focus:scale-110 
    hover:scale-110 hover:bg-gray-950 active:scale-150 dark:bg-white dark:bg-opacity-10
