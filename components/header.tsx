...
export default function Header() {
  ...
  return <header className='z-[999] relative'>
    ...
    backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.35rem] sm:w-[36rem] sm:rounded-full dark:bg-gray-950
      ...
      text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5'>
        {links.map((link) => (
          <motion.li 
            ...
            <Link
                className={clsx(
                  "flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 transition dark:text-gray-500 dark:hover:gray-300",
                  {
